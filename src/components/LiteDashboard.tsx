...
import { TrendsSection } from './LiteTrendsSection';
            ...
            <tbody>
              {filtered.map((loc, i) => (
                ...
                >
                  ...
                  {[loc.onboardedEmployeeCount ?? 0, loc.scans, loc.leads, loc.pullFiles, loc.employeeInitiated ?? 0, loc.customerSelfService ?? 0].map((val, j) => (
                    <td
                      key={j}
                      style={{
                        padding: '10px 14px',
